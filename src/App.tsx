...
function computeExportScale(el: HTMLElement, targetHeightPx: number) {
  const height = el.scrollHeight;
  if (!height) return 1;
  const scale = targetHeightPx / height;
...
export default function App() {
  ...
  const formGrid = (cols: 1 | 2) =>
    ({
      display: "grid",
      gap: 10,
      gridTemplateColumns: cols === 2 && !isInputsStack ? "1fr 1fr" : "1fr",
      alignItems: "stretch",
    } as const);
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            <h2 style={{ margin: "0 0 10px", fontSize: 14, fontWeight: 900 }}>
              Inputs
            </h2>
            ...
            <div style={{ display: "grid", gap: 12 }}>
              ...
              <div style={{ marginTop: 4 }}>
                ...
                <textarea
                  style={{ ...controlBase, minHeight: 110, resize: "vertical" }}
                  value={data.notes || ""}
              ...
              >
                ...
                >
                  ...
                  <div style={{ textAlign: "right" }}>
                    <div style={{ fontSize: 12, fontWeight: 900 }}>DATE</div>
                    <div style={{ fontSize: 12, opacity: 0.8 }}>
                      {header.date}
                    </div>
                    <div style={{ height: 8 }} />
                    <div style={{ fontSize: 12, fontWeight: 900 }}>SHIFT</div>
                    <div style={{ fontSize: 12, opacity: 0.8 }}>
                  ...
                  >
                    ...
                    <div style={{ fontSize: 12 }}>
                      <div>
                        ...
                        <span style={{ opacity: 0.85 }}>{data.teamLead}</span>
                      </div>
                      ...
                      <div style={{ display: "grid", gap: 6 }}>
                        {data.agents.length === 0 ? (
                          <div style={{ opacity: 0.7 }}>No agents listed.</div>
                        ) : (
                          data.agents.map((a, idx) => (
                            <div
                              key={idx}
                  ...
                  >
                    ...
                    <div style={{ fontSize: 12, display: "grid", gap: 10 }}>
                      ...
                      >
                        ...
                        >
                          <div>
                            <div style={{ fontWeight: 800 }}>Alpha (Main)</div>
                          ...
                          <div>
                            <div style={{ fontWeight: 800 }}>Bravo (Alt)</div>
                            <div style={{ fontSize: 11, opacity: 0.8 }}>
                              <span style={{ fontWeight: 900 }}>Arr:</span>{" "}
                      ...
                      <div style={{ opacity: 0.7, fontSize: 11 }}>
                        (Pins can be cross-streets, landmarks, or GPS pins. Keep
                        it brief for 1-page export.)
                      </div>
                    </div>
                  </section>
                  ...
                  >
                    ...
                    <div style={{ display: "grid", gap: 10, fontSize: 12 }}>
                      <div>
                        ...
                        <div style={{ opacity: 0.85 }}>{vErAddress || ""}</div>
                        <div style={{ opacity: 0.85 }}>{vErPhone || ""}</div>
                      </div>
                      ...
                      >
                        ...
                        <div style={{ opacity: 0.85 }}>{vLeAddress || ""}</div>
                        <div style={{ opacity: 0.85 }}>{vLePhone || ""}</div>
                      </div>
                    </div>
                  </section>
                </div>
                      ...
                      {data.boloPois.map((b, idx) => (
                        ...
                        >
                          ...
                          >
                            ...
                            {b.action?.trim() ? (
                              <div style={{ fontSize: 11, opacity: 0.8 }}>
                                <span style={{ fontWeight: 900 }}>Action:</span>{" "}
                                {b.action}
                              </div>
                            ) : null}
                          </div>
